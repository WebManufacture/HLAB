...
Channel.prototype.create = function(route){
	route = Channel.ParsePath(route);
	return this._createRoute(this.routes, route);
}

Channel.prototype.exists = function(route){
	route = Channel.ParsePath(route);
	return this._getRoute(this.routes, route) != null;
}
